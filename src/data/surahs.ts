...
export const surahs: Surah[] = [
  ...
  { number: 51, name: "الذاريات", englishName: "Adh-Dhariyat", englishNameTranslation: "The Scatterers", numberOfAyahs: 60, revelationType: "Meccan" },
  ...
  { number: 58, name: "المجادلة", englishName: "Al-Mujadila", englishNameTranslation: "The Disputation", numberOfAyahs: 22, revelationType: "Medinan" },
  { number: 59, name: "الحشر", englishName: "Al-Hashr", englishNameTranslation: "The Gathering", numberOfAyahs: 24, revelationType: "Medinan" },
  { number: 60, name: "الممتحنة", englishName: "Al-Mumtahana", englishNameTranslation: "The Examined One", numberOfAyahs: 13, revelationType: "Medinan" },
...
export const reciters = [
  ...
  { id: "ar.minshawi", name: "محمد صديق المنشاوي", englishName: "Mohamed Siddiq El-Minshawi" },
  { id: "ar.abdulsamad", name: "عبد الباسط - مجود", englishName: "Abdul Basit (Mujawwad)" },
];
